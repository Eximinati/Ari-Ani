...
const { Collection, Simple } = require("./src/typings");
const Welcome = require("./src/handler/EventHandler");
...
const Auth = require("./src/typings/authstore");
...
const connect = async () => {
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    require("./src/handler/MessageHandler")(client, m, Commands, chatUpdate);
  });
