const { fetchBuffer, fetchJson, GIFBufferToVideoBuffer } = require('../../lib/myfunc.js');

const suitableWords = {
  awoo: 'Awooed at', bite: 'Bit', blush: 'Blushed at', bonk: 'Bonked', bully: 'Bullied', cringe: 'Cringed at',
